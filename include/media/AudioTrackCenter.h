...
public:
    ...
    virtual ~AudioTrackCenter();
        ...
        status_t addTrack(intptr_t trackId, uint32_t frameCount, uint32_t sampleRate, void* trackPtr,  uint32_t afFrameCount, uint32_t afSampleRate, uint32_t afLatency, uint32_t framesFilled);
